...
export function Hero() {
  ...
  return (
    <section
      ...
      className="relative flex min-h-[calc(100dvh-11rem)] w-full items-center justify-center overflow-x-clip overflow-y-hidden bg-background text-foreground md:min-h-[calc(100dvh-13rem)]"
    >
      <h1 id="hero-heading" className="sr-only">
        Childance Factory — Season 12 now live
      </h1>
      <div className="@container flex w-full flex-col" aria-hidden="true">
        ...
        >
          <div className="relative flex items-center justify-center bg-brand-red py-[0.02em] transition-[filter] duration-700 ease-out group-has-[a:hover]/hero:invert">
            <p className="font-swiss flex items-center text-[1.598em] font-bold leading-[1.065] tracking-tighter text-black select-none">
              LIVE
              <span
