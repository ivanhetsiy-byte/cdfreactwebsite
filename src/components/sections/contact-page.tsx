...
const COPY = {
  ...
  details: {
    ...
    phone: { label: "Phone", value: STUDIO_PHONE_DISPLAY },
    address: {
      label: "Address",
      value: STUDIO_ADDRESS_LINE,
    },
    follow: "Follow Us",
  },
} as const;
...
const COPY_BTN_CLASS =
  "inline-flex shrink-0 cursor-pointer items-center justify-center rounded-sm p-1.5 text-[#999999] transition-colors duration-150 hover:text-black focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black dark:text-[#666666] dark:hover:text-white dark:focus-visible:outline-white";
